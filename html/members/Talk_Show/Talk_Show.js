document.addEventListener("DOMContentLoaded", function() {
    ...
    let coreMembers = [
        { name: "Sanket_Khatode", inst : "Amrutvahini College of Engineering"},
        { name: "Vaibhav_Khatal",inst : "Amrutvahini College of Engineering"},
        ];
    ...
    coreMembers.forEach(member => {
        ...
        image.src = `Talk_Show/${member.name}.png`;
