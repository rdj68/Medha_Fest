document.addEventListener("DOMContentLoaded", function () {
  ...
  let centralMembers = [
    { name: "Shubham_Datir", inst: "Amrutvahini College of Engineering" },
    { name: "Gaurav_Bodhak", inst: "Amrutvahini College of Engineering" },
  ];
  ...
  centralMembers.forEach((member) => {
    ...
    image.src = `Medha_Cup/${member.name}.png`;
