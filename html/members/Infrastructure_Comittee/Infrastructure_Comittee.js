document.addEventListener("DOMContentLoaded", function() {
    ...
    let coreMembers = [
        { name: "Shubham_Dhage", inst : "Amrutvahini College of Engineering"},
        { name: "Aditya_Badhe",inst : "Amrutvahini College of Engineering"},
        ];
    ...
    coreMembers.forEach(member => {
        ...
        image.src = `Infrastructure_Comittee/${member.name}.png`;
