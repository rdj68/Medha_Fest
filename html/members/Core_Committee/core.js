document.addEventListener("DOMContentLoaded", function () {
  ...
  let coreMembers = [
    ...
    {
      name: "Shraddha_Kadhane",
      inst: "Amrutvahini College of Engineering (MBA)",
    },
    { name: "Manish_Pingale", inst: "Amrutvahini College of Polytechnic" },
    {
      name: "Sayali_Naikwadi",
      inst: "Amrutvahini Intitute of Business Administration",
    },
    { name: "Anvit_Limbekar", inst: "Amrutvahini Nido International School" },
    {
      name: "Nandini_Fatangare",
      inst: "Amrutvahini Model School and Junior College",
    },
