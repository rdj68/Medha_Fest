document.addEventListener("DOMContentLoaded", function () {
  ...
  let coreMembers = [
    { name: "Advait_Sakhare", inst: "Amrutvahini College of Engineering" },
    { name: "Shubham_Sonavane", inst: "Amrutvahini College of Engineering" },
    { name: "Medhaj_Wachaure", inst: "Amrutvahini College of Engineering" },
    { name: "Vedant_Barguje", inst: "Amrutvahini College of Engineering" },
    { name: "Soham_Avhad", inst: "Amrutvahini College of Engineering" },
    { name: "Pranav_Darade", inst: "Amrutvahini College of Engineering" },
  ];
  ...
  coreMembers.forEach((member) => {
    ...
    image.src = `Social_Media/${member.name}.png`;
