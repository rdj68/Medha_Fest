document.addEventListener("DOMContentLoaded", function () {
  ...
  let centralMembers = [
    { name: "Pravin_Funde", inst: "Amrutvahini College of Engineering" },
    { name: "Vedashri_Waman", inst: "Amrutvahini College of Engineering" },
    { name: "Tejal_Thorat", inst: "Amrutvahini College of Engineering" },
    { name: "Vaishnavi_Pansare", inst: "Amrutvahini College of Engineering" },
  ];
  ...
  centralMembers.forEach((member) => {
    ...
    image.src = `anchoring/${member.name}.png`;
