document.addEventListener("DOMContentLoaded", function() {
    ...
    let coreMembers = [
        { name: "Prasana_Dhamale", inst : "Amrutvahini College of Engineering"},
        { name: "Sandesh_Dhage",inst : "Amrutvahini College of Engineering"},
        ];
    ...
    coreMembers.forEach(member => {
        ...
        image.src = `Singing/${member.name}.png`;
